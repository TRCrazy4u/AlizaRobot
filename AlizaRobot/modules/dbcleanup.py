...
import AlizaRobot.modules.sql.global_bans_sql as gban_sql
import AlizaRobot.modules.sql.users_sql as user_sql
from AlizaRobot import DEV_USERS, OWNER_ID, dispatcher
