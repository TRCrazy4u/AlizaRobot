...
import AlizaRobot.modules.sql.language_sql as sql
from AlizaRobot.langs import get_language, get_languages, get_string
from AlizaRobot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from AlizaRobot.modules.helper_funcs.decorators import Exoncallback, Exoncmd
...
def gs(chat_id: Union[int, str], string: str) -> str:
    try:
        ...
        return "Me now busy when free add this "


@Alizacmd(command="language")
@user_admin
...
@Alizacallback(pattern=r"setLang_")
@user_admin_no_reply
